...
from .control_smoothing import (
    apply_control_sequence_constraints_3d,
...
class Optimizer3D:
    ...
    def reset(self, seed: int = 0):
        ...
        self.control_history_ = create_control_history_3d()
    ...
    def _update_control_sequence(
        ...
        return apply_control_sequence_constraints_3d(sequence, self.settings_)
