...
echo ""
echo -e "  ${YELLOW}source /home/pengchen/EXACT-mppi/.exact_mppi/bin/activate${NC}"
echo -e "  ${YELLOW}python -m pip install -e /home/pengchen/EXACT-mppi/EXACT_MPPI_core${NC}"
echo ""
