...
**This simulator package builds on the original IR-SIM repository by Ruihua Han and contributors:**
https://github.com/hanruihua/ir-sim

**The original project identity, license, and community guidelines are retained here.** Local updates in this repository mainly focus on compatibility with the EXACT MPPI workflows, including extensions around omni-directional robot usage and multi-polygon robot shape support.
